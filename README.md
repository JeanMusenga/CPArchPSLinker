...
This repository includes an introduction and research methodology overview, a description of the CPArchPSLinker, its source code and baselines, the dataset of GitHub and Stack Overflow posts used in our study, and the experimental results.
...
heterogeneity and distribution divergence between GitHub and SO artifacts. The DMLbased model jointly projects architectural problems described in commits or issues and architectural
...
architecture-aware association features, and the relevance probabilities predicted by the DMLbased model in Stage-1. These features are jointly leveraged within a learning-to-rank model to
